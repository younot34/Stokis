...
<body class="bg-gray-100 font-sans" x-data="{ openSidebar: false }">
    ...
    <header class="flex items-center justify-between bg-gray-800 text-white px-4 py-3 md:hidden">
        <h1 class="text-lg font-bold">Stokis Panel</h1>
    ...
    <div class="flex min-h-screen relative">
        ...
        <aside
            ...
            <h1 class="text-2xl font-bold mb-8 hidden md:block">Stokis Panel</h1>
                ...
                <ul class="space-y-2">
                    <li>
                        <a href="{{ route('warehouse.dashboard') }}"
                           ...
                           {{ request()->routeIs('warehouse.dashboard') ? 'bg-gray-700 text-white' : 'hover:bg-gray-700' }}">
                           Dashboard
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('warehouse.transactions.index') }}"
                           class="block p-2 rounded
                           {{ request()->routeIs('warehouse.transactions.*') ? 'bg-gray-700 text-white' : 'hover:bg-gray-700' }}">
                           Barang Keluar
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('warehouse.purchase_orders.index') }}"
                           class="block p-2 rounded
                           {{ request()->routeIs('warehouse.purchase_orders.*') ? 'bg-gray-700 text-white' : 'hover:bg-gray-700' }}">
                           Permintaan Barang
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('warehouse.stocks.index') }}"
                           class="block p-2 rounded
                           {{ request()->routeIs('warehouse.stocks.*') ? 'bg-gray-700 text-white' : 'hover:bg-gray-700' }}">
                           Stok Barang
                        </a>
                    </li>
                </ul>
